...
class GymFitness_Classes_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            'gymfitness_classes',
            // Base ID
            esc_html__('GymFitness - Classes List', 'text_domain'),
            // Name
            array(
                'description' => esc_html__('Displays different classes in the widget', 'text_domain'),
            ) // Args
        );
    }
    ...
    public function form($instance)
    {
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('quantity')); ?>"
                name="<?php echo esc_attr($this->get_field_name('quantity')); ?>" type="number"
                value="<?php echo esc_attr($title); ?>" min="1">
