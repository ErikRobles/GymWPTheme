...
Description: Add Post Types to site Gym Fitness
Plugin URI: http://example.com/gym-fitness-wp-theme-plugin
Version: 1.0.0
Author: Erik Robles
Author URI: https://www.linkedin.com/in/erik-james-245067a8/
Text Domain: gym-fitness-wp-theme-plugin
*/
...
//         'view_items' => __('View Instructor', 'gymfitness'),
...
//         'items_list_navigation' => __('Navigate to Instructor', 'gymfitness'),
//         'filter_items_list' => __('Filter Instructors', 'gymfitness'),
//     );
//     $args = array(
//         'label' => __('Instructor', 'gymfitness'),
//         'description' => __('Instructor for Website', 'gymfitness'),
//         'labels' => $labels,
//         'supports' => array('title', 'editor', 'thumbnail'),
//         'hierarchical' => false,
//         'public' => true,
...
// }
// add_action('init', 'gymfitness_Instructor', 0);
...
//         'uploaded_to_this_item' => __('Add in Testimonial', 'gymfitness'),
//         'items_list' => __('List of Testimonials', 'gymfitness'),
...
//         'description' => __('Testimonials for Website', 'gymfitness'),
//         'labels' => $labels,
//         'supports' => array('title', 'editor', 'thumbnail'),
//         'hierarchical' => false,
//         'public' => true,
